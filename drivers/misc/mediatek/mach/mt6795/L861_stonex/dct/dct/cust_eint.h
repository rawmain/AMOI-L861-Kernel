...
#define CUST_EINT_WMCODEC_EINT_NUM              149
#define CUST_EINT_WMCODEC_EINT_DEBOUNCE_CN      0
#define CUST_EINT_WMCODEC_EINT_TYPE							CUST_EINTF_TRIGGER_LOW
#define CUST_EINT_WMCODEC_EINT_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
