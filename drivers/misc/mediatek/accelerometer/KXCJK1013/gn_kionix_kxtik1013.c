...
static struct i2c_board_info __initdata i2c_kxtik1013={ I2C_BOARD_INFO(KXTIK1013_DEV_NAME,0x0E)};//     (0x1e>>1)
...
//	misc_deregister(&kxtik1013_device);  by huangwb 20150107
