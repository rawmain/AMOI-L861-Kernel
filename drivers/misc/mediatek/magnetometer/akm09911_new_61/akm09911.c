...
/*----------------------------------------------------------------------------*/
static const struct i2c_device_id akm09911_i2c_id[] = {{AKM09911_DEV_NAME,2},{}};
		...
		void* buff_out, int size_out, int* actualout)
{
	...
	if(atomic_read(&data->trace) & AMK_FUN_DEBUG)
	{
		MAG_ERR("akm09911_orientation_operate");
	}	
#endif
...
static int akm09911_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	printk("huangwb..a\n");
	mt_set_gpio_mode(GPIO148 | 0x80000000, GPIO_MODE_00);	
	mt_set_gpio_dir(GPIO148 | 0x80000000, GPIO_DIR_OUT);	
	mt_set_gpio_out(GPIO148 | 0x80000000, GPIO_OUT_ONE);
	MAGN_FUN();
