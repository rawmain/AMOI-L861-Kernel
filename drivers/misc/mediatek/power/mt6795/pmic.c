...
kal_uint32 upmu_get_rgs_chrdet(void)
{
    ...
    pr_notice("[charging_get_charger_det_status] CHRDET status = %d\n", val);
...
{
    pr_notice( "[register_battery_oc_notify] start\n");

    occb_tb[prio_val].occb = battery_oc_callback;

    pr_notice( "[register_battery_oc_notify] prio_val=%d\n",prio_val);
}
    ...
    else
    {
        for(i=0 ; i<OCCB_NUM ; i++)
        {
            if(occb_tb[i].occb != NULL)
            {
                ...
                pr_notice( "[exec_battery_oc_callback] prio_val=%d,battery_oc_level=%d\n",i,battery_oc_level);
            }
        }
    }
}
...
void battery_oc_protect_init(void)
{
    if( get_mt6332_pmic_chip_version() >= PMIC6332_E2_CID_CODE)
    {
        ...
        pr_notice( "[battery_oc_protect_init] Done\n");
    }
    else
    {
        pr_notice( "[battery_oc_protect_init] E1 cannot support\n");
    }
}
...
{
    pr_notice( "[register_battery_percent_notify] start\n");

    bpcb_tb[prio_val].bpcb = battery_percent_callback;

    pr_notice( "[register_battery_percent_notify] prio_val=%d\n",prio_val);

    if( (g_battery_percent_stop==0) && (g_battery_percent_level==1) )
    {
        pr_notice( "[register_battery_percent_notify] level l happen\n");
    ...
    else
    {
        for(i=0 ; i<BPCB_NUM ; i++)
        {
            if(bpcb_tb[i].bpcb != NULL)
            {
                ...
                pr_notice( "[exec_battery_percent_callback] prio_val=%d,battery_percent_level=%d\n",i,battery_percent_level);
            }
        }
    }
}
...
int bat_percent_notify_handler(void *unused)
{
    ...
    do
    {
        ...
        pr_notice( "bat_per_level=%d,bat_per_val=%d\n",g_battery_percent_level,bat_per_val);
...
enum hrtimer_restart bat_percent_notify_task(struct hrtimer *timer)
{
    ...
    pr_notice( "bat_percent_notify_task is called\n");
...
void bat_percent_notify_init(void)
{
    ...
    {
        pr_notice( "Create bat_percent_notify_thread : done\n");
    }
}
...
void homekey_int_handler(void)
{
    ...
    pr_notice( "[homekey_int_handler]....\n");

    if(mt6331_upmu_get_homekey_deb()==1)
    {
        pr_notice( "[homekey_int_handler] Release homekey\n");
        kpd_pmic_rstkey_handler(0x0);
        //mt6331_upmu_set_rg_homekey_int_sel(0);
    }
    else
    {
        pr_notice( "[homekey_int_handler] Press homekey\n");
...
void mt6331_thr_h_int_handler(void)
{
    ...
    pr_notice( "[mt6331_thr_h_int_handler]....\n");
...
void mt6331_thr_l_int_handler(void)
{
    ...
    pr_notice( "[mt6331_thr_l_int_handler]....\n");
...
void mt6331_bat_h_int_handler(void)
{
    ...
    pr_notice( "[mt6331_bat_h_int_handler]....\n");
...
void mt6331_bat_l_int_handler(void)
{
    ...
    pr_notice( "[mt6331_bat_l_int_handler]....\n");
...
void accdet_eint_int_handler(void)
{
    ...
    pr_notice( "[accdet_eint_int_handler]....\n");
...
void accdet_negv_int_handler(void)
{
    ...
    pr_notice( "[accdet_negv_int_handler]....\n");
...
void vdvfs11_oc_int_handler(void)
{
    ...
    pr_notice( "[vdvfs11_oc_int_handler]....\n");
...
void vdvfs12_oc_int_handler(void)
{
    ...
    pr_notice( "[vdvfs12_oc_int_handler]....\n");
...
void vdvfs13_oc_int_handler(void)
{
    ...
    pr_notice( "[vdvfs13_oc_int_handler]....\n");
...
void vdvfs14_oc_int_handler(void)
{
    ...
    pr_notice( "[vdvfs14_oc_int_handler]....\n");
...
void vcore1_oc_int_handler(void)
{
    ...
    pr_notice( "[vcore1_oc_int_handler]....\n");
...
void vcore2_oc_int_handler(void)
{
    ...
    pr_notice( "[vcore2_oc_int_handler]....\n");
...
void vio18_oc_int_handler(void)
{
    ...
    pr_notice( "[vio18_oc_int_handler]....\n");
...
void mt6331_ldo_oc_int_handler(void)
{
    ...
    pr_notice( "[mt6331_ldo_oc_int_handler]....\n");
...
void flash_vled1_short_int_handler(void)
{
    ...
    pr_notice( "[flash_vled1_short_int_handler]....\n");
...
void flash_vled1_open_int_handler(void)
{
    ...
    pr_notice( "[flash_vled1_open_int_handler]....\n");
...
void chr_plug_in_int_handler(void)
{
    ...
    pr_notice( "[chr_plug_in_int_handler]....\n");
...
void chr_plug_out_int_handler(void)
{
    ...
    pr_notice( "[chr_plug_out_int_handler]....\n");
...
void bc11_timeout_int_handler(void)
{
    ...
    pr_notice( "[bc11_timeout_int_handler]....\n");
...
void flash_vled2_short_int_handler(void)
{
    ...
    pr_notice( "[flash_vled2_short_int_handler]....\n");
...
void flash_vled2_open_int_handler(void)
{
    ...
    pr_notice( "[flash_vled2_open_int_handler]....\n");
...
void mt6332_thr_h_int_handler(void)
{
    ...
    pr_notice( "[mt6332_thr_h_int_handler]....\n");
...
void mt6332_thr_l_int_handler(void)
{
    ...
    pr_notice( "[mt6332_thr_l_int_handler]....\n");
...
void mt6332_bat_h_int_handler(void)
{
    ...
    pr_notice( "[mt6332_bat_h_int_handler]....\n");
...
void mt6332_bat_l_int_handler(void)
{
    ...
    pr_notice( "[mt6332_bat_l_int_handler]....\n");
...
void fg_bat_h_int_handler(void)
{
    ...
    pr_notice( "[fg_bat_h_int_handler]....\n");
...
void fg_bat_l_int_handler(void)
{
    ...
    pr_notice( "[fg_bat_l_int_handler]....\n");
...
void vwled_oc_int_handler(void)
{
    ...
    pr_notice( "[vwled_oc_int_handler]....\n");
...
void fg_cur_h_int_handler(void)
{
    ...
    pr_notice( "[fg_cur_h_int_handler]....\n");
...
void fg_cur_l_int_handler(void)
{
    ...
    pr_notice( "[fg_cur_l_int_handler]....\n");
...
void vdram_oc_int_handler(void)
{
    ...
    pr_notice( "[vdram_oc_int_handler]....\n");
...
void vdvfs2_oc_int_handler(void)
{
    ...
    pr_notice( "[vdvfs2_oc_int_handler]....\n");
...
void vsbst_oc_int_handler(void)
{
    ...
    pr_notice( "[vsbst_oc_int_handler]....\n");
...
{
    pr_notice( "[mt_pmic_eint_irq_mt6331] receive interrupt\n");
    wake_up_pmic_mt6331();
    return ;
}
...
{
    pr_notice( "[mt_pmic_eint_irq_mt6332] receive interrupt\n");
    wake_up_pmic_mt6332();
    return ;
}
...
void PMIC_EINT_SETTING(void)
{
    ...
    pr_notice( "[CUST_EINT] mt6331_irq=%d\n", g_mt6331_irq);
    pr_notice( "[CUST_EINT] mt6332_irq=%d\n", g_mt6332_irq);
    ...
    pr_notice( "[CUST_EINT] CUST_EINT_MT_PMIC_MT6331_NUM=%d\n", g_eint_pmit_mt6331_num);
    pr_notice( "[CUST_EINT] CUST_EINT_MT_PMIC_MT6332_NUM=%d\n", g_eint_pmit_mt6332_num);
    pr_notice( "[CUST_EINT] CUST_EINT_PMIC_DEBOUNCE_CN=%d\n", g_cust_eint_mt_pmic_debounce_cn);
    pr_notice( "[CUST_EINT] CUST_EINT_PMIC_TYPE=%d\n", g_cust_eint_mt_pmic_type);
    pr_notice( "[CUST_EINT] CUST_EINT_PMIC_DEBOUNCE_EN=%d\n", g_cust_eint_mt_pmic_debounce_en);
#endif
...
static ssize_t store_pmic_access(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
        pr_notice( "[store_pmic_access] buf is %s \n",buf);
...
{
    pr_notice( "[dct_pmic_VTCXO1_enable] %d\n", dctEnable);
...
{
    pr_notice( "[dct_pmic_VTCXO2_enable] %d\n", dctEnable);
...
{
    pr_notice( "[dct_pmic_VAUD32_enable] %d\n", dctEnable);
...
{
    pr_notice( "[dct_pmic_VAUXA32_enable] %d\n", dctEnable);
...
{
    pr_notice( "[dct_pmic_VEMC33_enable] %d\n", dctEnable);
...
{
    pr_notice( "[dct_pmic_VGP4_enable] %d\n", dctEnable);
...
{
    pr_notice( "[dct_pmic_VFBB_enable] %d\n", dctEnable);

    #ifdef MTK_PMIC_DVT_SUPPORT
    upmu_set_reg_value(MT6331_TOP_CKPDN_CON1_CLR, 0x200);
    pr_notice( "[dct_pmic_VFBB_enable] REG[0x%x] = 0x%x\n",
...
{
    pr_notice( "[dct_pmic_VMIPI_enable] %d\n", dctEnable);
...
{
    pr_notice( "[dct_pmic_MT6331_VDIG18_enable] no en bit\n");
}
...
{
    pr_notice( "[dct_pmic_VUSB10_enable] %d\n", dctEnable);
...
{
    pr_notice( "[dct_pmic_VSRAM_DVFS1_enable] %d\n", dctEnable);
...
{
    pr_notice( "[dct_pmic_VBIASN_enable] %d\n", dctEnable);
...
{
    pr_notice( "[dct_pmic_VBIF28_enable] %d\n", dctEnable);
...
{
    pr_notice( "[dct_pmic_VAUXB32_enable] %d\n", dctEnable);
...
{
    pr_notice( "[dct_pmic_VUSB33_enable] %d\n", dctEnable);
...
{
    pr_notice( "[dct_pmic_MT6332_VDIG18_enable] no en bit\n");
}

void dct_pmic_VSRAM_DVFS2_enable(kal_bool dctEnable)
{
    pr_notice( "[dct_pmic_VSRAM_DVFS2_enable] %d\n", dctEnable);
...
{
    pr_notice( "****[dct_pmic_VTCXO1_sel] value=%d \n", volt);
...
{
    pr_notice( "****[dct_pmic_VTCXO2_sel] value=%d \n", volt);
...
{
    pr_notice( "****[dct_pmic_VAUD32_sel] value=%d \n", volt);
...
{
    pr_notice( "****[dct_pmic_VAUXA32_sel] value=%d \n", volt);
...
{
    pr_notice( "****[dct_pmic_VEMC33_sel] value=%d \n", volt);
...
{
    pr_notice( "****[dct_pmic_VIO28_sel] value=%d \n", volt);
...
{
    pr_notice( "****[dct_pmic_VGP4_sel] value=%d \n", volt);

    if(get_pmic_mt6331_cid()==PMIC6331_E1_CID_CODE)
    {
        pr_notice( "****[dct_pmic_VGP4_sel] MT6331==E1\n");
    ...
    {
        pr_notice( "****[dct_pmic_VGP4_sel] MT6331>=E2\n");
...
void dct_pmic_VSIM1_sel(kal_uint32 volt)
{
    ...
    if(get_pmic_mt6331_cid()==PMIC6331_E1_CID_CODE)
    {
        pr_notice( "****[dct_pmic_VSIM1_sel] MT6331==E1\n");
    ...
    {
        pr_notice( "****[dct_pmic_VSIM1_sel] MT6331>=E2\n");
...
void dct_pmic_VSIM2_sel(kal_uint32 volt)
{
    ...
    if(get_pmic_mt6331_cid()==PMIC6331_E1_CID_CODE)
    {
        pr_notice( "****[dct_pmic_VSIM2_sel] MT6331==E1\n");
    ...
    {
        pr_notice( "****[dct_pmic_VSIM2_sel] MT6331>=E2\n");
...
{
    pr_notice( "****[dct_pmic_VFBB_sel] value=%d \n", volt);
...
{
    pr_notice( "****[dct_pmic_VRTC_sel] value=%d \n", volt);
...
{
    pr_notice( "****[dct_pmic_VMIPI_sel] value=%d \n", volt);
...
{
    pr_notice( "****[dct_pmic_MT6331_VDIG18_sel] value=%d \n", volt);
...
{
    pr_notice( "****[dct_pmic_VUSB10_sel] value=%d \n", volt);
...
{
    pr_notice( "****[dct_pmic_VCAM_IO_sel] value=%d \n", volt);
...
void dct_pmic_VSRAM_DVFS1_sel(kal_uint32 volt)
{
    ...
    pr_notice( "****[dct_pmic_VSRAM_DVFS1_sel] value=%d, val=%d \n", volt, val);
}
...
void dct_pmic_VGP2_sel(kal_uint32 volt)
{
    ...
    if(get_pmic_mt6331_cid()==PMIC6331_E1_CID_CODE)
    {
        pr_notice( "****[dct_pmic_VGP2_sel] MT6331==E1\n");
    ...
    {
        pr_notice( "****[dct_pmic_VGP2_sel] MT6331>=E2\n");
...
void dct_pmic_VBIASN_sel(kal_uint32 volt)
{
    ...
    pr_notice( "****[dct_pmic_VBIASN_sel] value=%d, val=%d \n", volt, val);
}

void dct_pmic_VBIF28_sel(kal_uint32 volt)
{
    pr_notice( "****[dct_pmic_VBIF28_sel] value=%d \n", volt);
...
{
    pr_notice( "****[dct_pmic_VAUXB32_sel] value=%d \n", volt);
...
{
    pr_notice( "****[dct_pmic_VUSB33_sel] value=%d \n", volt);
...
{
    pr_notice( "****[dct_pmic_MT6332_VDIG18_sel] value=%d \n", volt);
...
void dct_pmic_VSRAM_DVFS2_sel(kal_uint32 volt)
{
    ...
    pr_notice( "****[dct_pmic_VSRAM_DVFS2_sel] value=%d, val=%d \n", volt, val);
}
#endif
...
void dump_ldo_status_read_debug(void)
{
    ...
    pr_notice("********** BUCK/LDO status dump [1:ON,0:OFF]**********\n");

    pr_notice("DVFS11      =%d, ",  (((val_0)&(0x0001))>>0) );
    pr_notice("DVFS12      =%d, ",  (((val_0)&(0x0002))>>1) );
    pr_notice("DVFS13      =%d, ",  (((val_0)&(0x0004))>>2) );
    pr_notice("DVFS14      =%d\n",  (((val_0)&(0x0008))>>3) );

    pr_notice("VGPU        =%d, ",  (((val_0)&(0x0010))>>4) );
    pr_notice("VCORE1      =%d, ",  (((val_0)&(0x0020))>>5) );
    pr_notice("VCORE2      =%d, ",  (((val_0)&(0x0040))>>6) );
    pr_notice("VIO18       =%d\n",  (((val_0)&(0x0080))>>7) );

    pr_notice("NA          =%d, ",  (((val_0)&(0x0100))>>8) );
    pr_notice("VRTC        =%d, ",  (((val_0)&(0x0200))>>9) );
    pr_notice("VTCXO1      =%d, ",  (((val_0)&(0x0400))>>10) );
    pr_notice("VTCXO2      =%d\n",  (((val_0)&(0x0800))>>11) );

    pr_notice("VAUD32      =%d, ",  (((val_0)&(0x1000))>>12) );
    pr_notice("VAUXA32     =%d, ",  (((val_0)&(0x2000))>>13) );
    pr_notice("VCAMA       =%d, ",  (((val_0)&(0x4000))>>14) );
    pr_notice("VIO28       =%d\n",  (((val_0)&(0x8000))>>15) );
    //------------------------------------------------------------------
    pr_notice("VCAM_AF     =%d, ",  (((val_1)&(0x0001))>>0) );
    pr_notice("VMC         =%d, ",  (((val_1)&(0x0002))>>1) );
    pr_notice("VMCH        =%d, ",  (((val_1)&(0x0004))>>2) );
    pr_notice("VEMC33      =%d\n",  (((val_1)&(0x0008))>>3) );

    pr_notice("VGP1        =%d, ",  (((val_1)&(0x0010))>>4) );
    pr_notice("VGP4        =%d, ",  (((val_1)&(0x0020))>>5) );
    pr_notice("VSIM1       =%d, ",  (((val_1)&(0x0040))>>6) );
    pr_notice("VSIM2       =%d\n",  (((val_1)&(0x0080))>>7) );

    pr_notice("VFBB        =%d, ",  (((val_1)&(0x0100))>>8) );
    pr_notice("VMIPI       =%d, ",  (((val_1)&(0x0200))>>9) );
    pr_notice("VIBR        =%d, ",  (((val_1)&(0x0400))>>10) );
    pr_notice("VCAMD       =%d\n",  (((val_1)&(0x0800))>>11) );

    pr_notice("VUSB10      =%d, ",  (((val_1)&(0x1000))>>12) );
    pr_notice("VCAM_IO     =%d, ",  (((val_1)&(0x2000))>>13) );
    pr_notice("VSRAM_DVFS1 =%d, ",  (((val_1)&(0x4000))>>14) );
    pr_notice("VGP2        =%d\n",  (((val_1)&(0x8000))>>15) );
    //------------------------------------------------------------------
    pr_notice("VGP3        =%d, ",  (((val_2)&(0x0001))>>0) );
    pr_notice("VBIASN      =%d\n",  (((val_2)&(0x0002))>>1) );
    //------------------------------------------------------------------
    pr_notice("VAUXB32     =%d, ",  (((val_3)&(0x0001))>>0) );
    pr_notice("VBIF28      =%d, ",  (((val_3)&(0x0002))>>1) );
    pr_notice("VUSB33      =%d, ",  (((val_3)&(0x0004))>>2) );
    pr_notice("VSRAM_DVFS2 =%d\n",  (((val_3)&(0x0008))>>3) );

    pr_notice("VDRAM       =%d, ",  (((val_3)&(0x0040))>>6) );
    pr_notice("VDVFS2      =%d\n",  (((val_3)&(0x0080))>>7) );

    pr_notice("VRF1        =%d, ",  (((val_3)&(0x0100))>>8) );
    pr_notice("VRF2        =%d, ",  (((val_3)&(0x0200))>>9) );
    pr_notice("VPA         =%d, ",  (((val_3)&(0x0400))>>10) );
    pr_notice("VSBST       =%d\n",  (((val_3)&(0x0800))>>11) );
}
...
static ssize_t store_low_battery_protect_ut(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
        pr_notice( "[store_low_battery_protect_ut] buf is %s \n",buf);
...
static ssize_t store_low_battery_protect_stop(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
        pr_notice( "[store_low_battery_protect_stop] buf is %s \n",buf);
        val = simple_strtoul(buf,&pvalue,16);
        if( (val!=0) && (val!=1) )
            val=0;
...
{
    pr_notice( "[show_battery_oc_protect_ut] g_battery_oc_level=%d\n", g_battery_oc_level);
    return sprintf(buf, "%u\n", g_battery_oc_level);
}
static ssize_t store_battery_oc_protect_ut(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    pr_notice( "[store_battery_oc_protect_ut] \n");

    if(buf != NULL && size != 0)
    {
        pr_notice( "[store_battery_oc_protect_ut] buf is %s \n",buf);
        val = simple_strtoul(buf,&pvalue,16);
        if(val<=1)
        {
            pr_notice( "[store_battery_oc_protect_ut] your input is %d\n", val);
            exec_battery_oc_callback(val);
        }
        else
        {
            pr_notice( "[store_battery_oc_protect_ut] wrong number (%d)\n", val);
        }
    }
    return size;
}
...
{
    pr_notice( "[show_battery_oc_protect_stop] g_battery_oc_stop=%d\n", g_battery_oc_stop);
    return sprintf(buf, "%u\n", g_battery_oc_stop);
}
static ssize_t store_battery_oc_protect_stop(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    pr_notice( "[store_battery_oc_protect_stop] \n");

    if(buf != NULL && size != 0)
    {
        pr_notice( "[store_battery_oc_protect_stop] buf is %s \n",buf);
        val = simple_strtoul(buf,&pvalue,16);
        if( (val!=0) && (val!=1) )
            val=0;
        g_battery_oc_stop = val;
        pr_notice( "[store_battery_oc_protect_stop] g_battery_oc_stop=%d\n", g_battery_oc_stop);
    }
    return size;
}
...
{
    pr_notice( "[show_battery_oc_protect_level] g_battery_oc_level=%d\n", g_battery_oc_level);
    return sprintf(buf, "%u\n", g_battery_oc_level);
}
static ssize_t store_battery_oc_protect_level(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    pr_notice( "[store_battery_oc_protect_level] g_battery_oc_level=%d\n", g_battery_oc_level);
...
{
    pr_notice( "[show_battery_percent_protect_ut] g_battery_percent_level=%d\n", g_battery_percent_level);
    return sprintf(buf, "%u\n", g_battery_percent_level);
}
static ssize_t store_battery_percent_protect_ut(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    pr_notice( "[store_battery_percent_protect_ut] \n");

    if(buf != NULL && size != 0)
    {
        pr_notice( "[store_battery_percent_protect_ut] buf is %s \n",buf);
        val = simple_strtoul(buf,&pvalue,16);
        if(val<=1)
        {
            pr_notice( "[store_battery_percent_protect_ut] your input is %d\n", val);
            exec_battery_percent_callback(val);
        }
        else
        {
            pr_notice( "[store_battery_percent_protect_ut] wrong number (%d)\n", val);
        }
    }
    return size;
}
...
{
    pr_notice( "[show_battery_percent_protect_stop] g_battery_percent_stop=%d\n", g_battery_percent_stop);
    return sprintf(buf, "%u\n", g_battery_percent_stop);
}
static ssize_t store_battery_percent_protect_stop(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    pr_notice( "[store_battery_percent_protect_stop] \n");

    if(buf != NULL && size != 0)
    {
        pr_notice( "[store_battery_percent_protect_stop] buf is %s \n",buf);
        val = simple_strtoul(buf,&pvalue,16);
        if( (val!=0) && (val!=1) )
            val=0;
        g_battery_percent_stop = val;
        pr_notice( "[store_battery_percent_protect_stop] g_battery_percent_stop=%d\n", g_battery_percent_stop);
    }
    return size;
}
...
{
    pr_notice( "[show_battery_percent_protect_level] g_battery_percent_level=%d\n", g_battery_percent_level);
    return sprintf(buf, "%u\n", g_battery_percent_level);
}
...
{
    pr_notice( "[store_battery_percent_protect_level] g_battery_percent_level=%d\n", g_battery_percent_level);
...
static ssize_t store_pmic_dvt(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    pr_notice("[store_pmic_dvt] \n");

    if(buf != NULL && size != 0)
    {
        pr_notice("[store_pmic_dvt] buf is %s \n",buf);
        test_item = simple_strtoul(buf,&pvalue,10);
        pr_notice("[store_pmic_dvt] test_item=%d\n", test_item);

        #ifdef MTK_PMIC_DVT_SUPPORT
        pmic_dvt_entry(test_item);
        #else
        pr_notice("[store_pmic_dvt] no define MTK_PMIC_DVT_SUPPORT\n");
        #endif
    }
    return size;
}
...
int is_ext_swchr_exist(void)
{
        ...
        {
            pr_notice( "[is_ext_swchr_exist] can access MT6332\n");
            return 1;
        }
        else
        {
            pr_notice( "[is_ext_swchr_exist] no define any HW\n");
            return 0;
        }
    #endif
}
...
void pmic_full_reset(void)
{
    ...
    ret_val=pmic_config_interface(MT6331_TOP_RST_MISC_SET, 0x0001, 0xFFFF, 0); //[0]=1, RG_WDTRSTB_EN
    pr_notice("[pmic_full_reset] Reg[0x%x]=0x%x\n", MT6331_TOP_RST_MISC, upmu_get_reg_value(MT6331_TOP_RST_MISC));
...
void PMIC_INIT_SETTING_V1(void)
{
    ...
    {
        pr_notice( "[Kernel_PMIC_INIT_SETTING_V1] 6331 PMIC Chip = 0x%x\n",mt6331_chip_version);
        pr_notice( "[Kernel_PMIC_INIT_SETTING_V1] 2014-05-08\n");
        ...
        #if 1
        pr_notice( "[PMIC INIT] Reg[0x%x]=0x%x\n", 0x4, upmu_get_reg_value(0x4));
    ...
    {
        pr_notice( "[Kernel_PMIC_INIT_SETTING_V1] 6331 PMIC Chip = 0x%x\n",mt6331_chip_version);
        pr_notice( "[Kernel_PMIC_INIT_SETTING_V1] 2014-03-10\n");
    ...
    {
        pr_notice( "[Kernel_PMIC_INIT_SETTING_V1] Unknown PMIC Chip (0x%x)\n",mt6331_chip_version);
    }
    ...
    {
        pr_notice( "[Kernel_PMIC_INIT_SETTING_V1] 6332 PMIC Chip = 0x%x\n",mt6332_chip_version);
        pr_notice( "[Kernel_PMIC_INIT_SETTING_V1] 2014-06-29_1\n");
...
void PMIC_INIT_SETTING_V2(void)
{
    ...
    {
        pr_notice( "[Kernel_PMIC_INIT_SETTING_V2] 6331 PMIC Chip = 0x%x\n",mt6331_chip_version);
        pr_notice( "[Kernel_PMIC_INIT_SETTING_V2] 2014-09-23\n");
    ...
    {
        pr_notice( "[Kernel_PMIC_INIT_SETTING_V2] Unknown PMIC Chip (0x%x)\n",mt6331_chip_version);
    }
    ...
    {
        pr_notice( "[Kernel_PMIC_INIT_SETTING_V2] 6332 PMIC Chip = 0x%x\n",mt6332_chip_version);
        pr_notice( "[Kernel_PMIC_INIT_SETTING_V2] 2014-10-24\n");
    ...
    switch(cmd)
    {
        //#if defined(FTM_EXT_BUCK_CHECK)
            case Get_IS_EXT_BUCK_EXIST:
                ...
                pr_notice( "[pmic_ftm_ioctl] Get_IS_EXT_BUCK_EXIST:%d\n", adc_out_data[0]);
            break;
        //#endif
        ...
        //#if defined(FTM_EXT_VBAT_BOOST_CHECK)
            case Get_IS_EXT_VBAT_BOOST_EXIST:
                ...
                ret = copy_to_user(user_data_addr, adc_out_data, 8);
                pr_notice( "[pmic_ftm_ioctl] Get_IS_EXT_VBAT_BOOST_EXIST:%d\n", adc_out_data[0]);
            break;
        //#endif
        ...
        //#if defined(FEATURE_FTM_SWCHR_HW_DETECT)
            case Get_IS_EXT_SWCHR_EXIST:
                ...
                ret = copy_to_user(user_data_addr, adc_out_data, 8);
                pr_notice( "[pmic_ftm_ioctl] Get_IS_EXT_SWCHR_EXIST:%d\n", adc_out_data[0]);
            break;
        //#endif

        default:
            pr_notice( "[pmic_ftm_ioctl] Error ID\n");
            break;
    }
...
void pmic_ftm_init(void)
{
    ...
    if (ret)
        pr_notice( "[pmic_ftm_init] Error: Can't Get Major number for pmic_ftm\n");
    ...
    if(ret)
        pr_notice( "[pmic_ftm_init] Error: cdev_add\n");
...
static void detect_battery_plug_out_status(void)
{
	...
	ret = pmic_read_interface(0x16, &plug_out_1, 0x1, 0); // [0:0]: STRUP_PWROFF_SEQ_EN; Ricky
        ...
        pr_notice( "[Power/PMIC] plug_out_1=%d, plug_out_2=%d\n", plug_out_1,plug_out_2);
...
static int pmic_mt_probe(struct platform_device *dev)
{
    ...
    //get PMIC CID
    pr_notice( "MT6331 PMIC CID=0x%x.\n", get_mt6331_pmic_chip_version());
    pr_notice( "MT6332 PMIC CID=0x%x.\n", get_mt6332_pmic_chip_version());
    ...
    pr_notice( "[PMIC HW pre-init] Reg[0x%x]=0x%x\n", 0x1E, upmu_get_reg_value(0x1E));
    pr_notice( "[PMIC HW pre-init] Reg[0x%x]=0x%x\n", 0x8C20, upmu_get_reg_value(0x8C20));
    ...
    if (0x6795 == code) {
        ...
        if(get_mt6331_pmic_chip_version()>=0x3120)
        {
            ...
            if(reg_val==0x0) {
                ...
                pr_notice("wrong reg_val=%d\n", reg_val);
            }
            pr_notice("[default turn off vsram at 31] [0x%x]=0x%x, [0x%x]=0x%x, [0x%x]=0x%x, reg_val=%d\n",
        ...
        #endif
        pr_notice( "[PMIC_INIT_SETTING_V2] Done..\n");
    } else {
    ...
    if(get_pmic_mt6332_cid() >= PMIC6332_E3_CID_CODE)
    {
        ...
        pr_notice( "[CONFIG_POWER_EXT] disable MT6332 CHRWDT (0x%x)\n", upmu_get_reg_value(0x80E0));
    }
    #endif
    ...
    if (IS_ERR(pmic_6331_thread_handle))
    {
        ...
        pr_notice( "[pmic_thread_kthread_mt6331] creation fails\n");
    }
    else
    {
        wake_up_process(pmic_6331_thread_handle);
        pr_notice( "[pmic_thread_kthread_mt6331] kthread_create Done\n");
    }
    ...
    if (IS_ERR(pmic_6332_thread_handle))
    {
        ...
        pr_notice( "[pmic_thread_kthread_mt6332] creation fails\n");
    }
    else
    {
        wake_up_process(pmic_6332_thread_handle);
        pr_notice( "[pmic_thread_kthread_mt6332] kthread_create Done\n");
    }
    ...
    pr_notice( "[PMIC] device_create_file for EM : done.\n" );
#endif
...
static int pmic_mt_suspend(struct platform_device *dev, pm_message_t state)
{
    ...
    if (Enable_BATDRV_LOG==2) {
        pr_notice( "Reg[0x%x]=0x%x, Reg[0x%x]=0x%x\n",
