...
#define AF_DRVNAME "DW9800AF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x18
#define PLATFORM_DRIVER_NAME "lens_actuator_dw9800af"
#define AF_DRIVER_CLASS_NAME "actuatordrv_dw9800af"
...
inline static int getAFInfo(__user stDW9800AF_MotorInfo * pstMotorInfo)
{
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stDW9800AF_MotorMETAInfo * pstMotorMETAInfo)
{
    stDW9800AF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stDW9800AF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case DW9800AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stDW9800AF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case DW9800AFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stDW9800AF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
